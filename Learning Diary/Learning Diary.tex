...
\begin{equation*}
	\operatornamewithlimits{argmin}_{\bfbeta}\left( \sum_{i=1}^{N}\left(y_i-\bfbeta^\intercal \mathbf{x}_i\right)^2\right)
\end{equation*}
we solve
\begin{equation*}
	\operatornamewithlimits{argmin}_{\bfbeta}\left( \sum_{i=1}^{N}\left(y_i-\bfbeta^\intercal \mathbf{x}_i\right)^2+\text{penalty}\right)
\end{equation*}
...
\begin{equation*} \hat{\bfbeta}^\mathrm{r}=\operatornamewithlimits{argmin}_{\bfbeta}\left( \sum_{i=1}^{N}\left(y_i-\bfbeta^\intercal \mathbf{x}_i\right)^2+\lambda\left\|\bfbeta\right\|^2\right),
\end{equation*}
where $\lambda$ is a positive real-valued (tuning) parameter.
