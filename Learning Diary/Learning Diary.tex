...
\begin{algorithm}
For a regression tree we use rectangles to partition the input space.
In each rectangle we then choose one of the input variables to split along and a point to split at.
This should be done so that the variance in the two new rectangles is minimized.
\end{algorithm}
